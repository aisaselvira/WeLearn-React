...
export default function RangkumanKimia() {
           ...
           <input type="checkbox" id="check-materi"/>
            <header className="header-materi">
                ...
                <div className="left-area-materi">
                  <h3 className="h3-left-area">KIMIA
                        <Link to="/home">
            ...
            <center>
                  ...
                  <ul>
                        ...
                        <Link to="/home/wemateri/materismp/mapelkelas7/materikimia">
                            <a href="beranda-materi-kimia.html"><i className="fas fa-desktop"></i><span>Beranda Materi</span>
                            </a>
                        </Link>
                        </li>
                        <li className="text-decoration-materi">
                              <Link to="/home/wemateri/materismp/mapelkelas7/materikimia/materipagekimia">
                                    <a href="materi-pembelajaran-indo.html"><i className="fas fa-book"></i><span>Materi</span></a>
                              </Link>
                        </li>
                        <li className="text-decoration-materi">
                        <Link to="/home/wemateri/materismp/mapelkelas7/materikimia/videomaterikimia">
                        ...
                        <Link to="/home/wemateri/materismp/mapelkelas7/materikimia/rangkumankimia">
                              <a href="rangkuman-materi-kimia.html"><i className="fas fa-file-word"></i><span>Rangkuman Materi</span></a>
                        </Link>
                        </li>
                        <li className="text-decoration-materi">
                        <Link to="/home/wemateri/materismp/mapelkelas7/materikimia/quizkimia">
        ...
        <div className="container-slider">
            {dataSlider.map((obj, index) => {
                return (
                    ...
                    >
                        <img 
                        src={process.env.PUBLIC_URL + `/Imgs/imgmtkk${index + 1}.png`} 
                        />
                    </div>
                )
            })}
