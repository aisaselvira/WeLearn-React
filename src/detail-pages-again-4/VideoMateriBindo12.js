...
function VideoMateriBindo12() {
  return (
      <div className="VideoMateriBindo12">
     <input type="checkbox" id="check-materi"/>
      ...
      <div className="sidebar-materi">
            ...
            <ul>
                  ...
                  <li className="text-decoration-materi">
                       <Link to="/home/wemateri/materisma/mapelkelas12/materibindo12/materipagebindo12">
                  ...
                  <li className="active-2-materi text-decoration-materi">
                        <Link to="/home/wemateri/materisma/mapelkelas12/materibindo12/videomateribindo12">
                              <a href="video-materi.html"><i className="fas fa-video"></i><span>Video Materi</span></a>
                        </Link>
                  </li>
                  <li className="text-decoration-materi">
                        <Link to="/home/wemateri/materisma/mapelkelas12/materibindo12/rangkumanbindo12">
                              <a href="rangkuman-materi-bindo.html"><i className="fas fa-file-word"></i><span>Rangkuman Materi</span></a>
                        </Link>
                  </li>
                  <li className="text-decoration-materi">
                        <Link to="/home/wemateri/materisma/mapelkelas12/materibindo12/quizbindo12">
...
export default VideoMateriBindo12