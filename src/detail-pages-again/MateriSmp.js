                  ...
                  <tr>
                        <td>
                              <div class="box-kls7">
                                    ...
                                    <button type="button" class="button-kls7"><a href="mata-pelajaran-kelas7.html"><strong>Belajar Sekarang</strong></a></button>
                                    </Link>
                                          <h1 class="text-kls">Materi Kelas 7</h1>
                                          <h2 class="text-kls2">Klik belajar sekarang untuk mendapatkan materi kelas 7 secara gratis</h2>
                              </div>
                        </td>
                        ...
                        <td>
                              <div class="box-kls8">
                                    ...
                                    <button type="button" class="button-kls8"><a href="mata-pelajaran-kelas8.html"><strong>Belajar Sekarang</strong></a></button>
                                    </Link>
                                          <h1 class="text-kls">Materi Kelas 8</h1>
                                          <h2 class="text-kls2">Klik belajar sekarang untuk mendapatkan materi kelas 8 secara gratis</h2>
                              </div>
                        </td>
                        ...
                        <td>
                              <div class="box-kls9">
                                    ...
                                    <button type="button" class="button-kls9"><a href="mata-pelajaran-kelas9.html"><strong>Belajar Sekarang</strong></a></button>
                                    </Link>
                                          <h1 class="text-kls">Materi Kelas 9</h1>
                                          <h2 class="text-kls2">Klik belajar sekarang untuk mendapatkan materi kelas 9 secara gratis</h2>
                              </div>
                        </td>
                  </tr>
            </table>
