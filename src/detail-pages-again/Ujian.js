    ...
    <div className="Ujian">
      ...
      <header className="header-materi-ujian">
        <div className="header-materi2-ujian">
          ...
          <div className="right-area">
            <a href="beranda.html" className="log-out-ujian">Back</a>
          </div>
        </div>
      </header>
      ...
      <div className="sidebar-ujian">
        <div className="left-area-ujian">
          <h3 className="h3-left-area-ujian"><span className="span-left-area-ujian">WeLearn</span></h3>
      </div>

        <div className="sidebar2-ujian">
          <center>
            <img className="profile-img-ujian" src={studentujian} alt="Welearn"/> 
          ...
          <ul>
            <li className="active-2-ujian text-decoration-ujian">
              <a href="ujian.html"
                ><i className="fas fa-book-open"></i><span>Ujian</span>
              </a>
            </li>
            ...
            <div className="colom2-ujian">
              ...
              <div className="status1-ujian">
                <button type="button" className="kerjakan-ujian">
                  <a
                    href="https://docs.google.com/forms/d/e/1FAIpQLSfwfh3MdW00iHyG_6jVlL_zLWJR1voUG-BJzhUoK73dv_7T-A/alreadyresponded">
