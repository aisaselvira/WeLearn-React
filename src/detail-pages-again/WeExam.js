    ...
    <section class="wexam" id="wexam">
      ...
      <div class="wexam-container">
        <div class="box">
          ...
          <div class="tombol">
            <a href="tka.html" class="button-aktif hijau"
              >TPA</a>
          

          <a href="tps.html" class="button-aktif hijau"
              >TPS</a>
          </div>
        </div>
        ...
        <div class="box">
          ...
          <div class="tombol">
            <a href="https://www.efset.org/quick-check" class="button-aktif hijau">Mulai Kerjakan !</a>
          </div>
        </div>
        ...
        <div class="box">
          ...
          <div class="tombol">
            <a href="https://www.16personalities.com/id/tes-kepribadian" class="button-aktif hijau">Mulai Kerjakan !</a>
          </div>
        </div>
      </div>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
